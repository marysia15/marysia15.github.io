...
**Gotowy tekst do skopiowania do maila/SMS:**
> Proszę o wpisanie 1,5% w moim rozliczeniu PIT za 2025 r.  
> **KRS (OPP): 0000382243**  
> **Cel szczegółowy: 1884 pomoc dla Marysi Wywiał**  
> Proszę upewnić się, że sekcja 1,5% jest uzupełniona we wszystkich składanych przeze mnie zeznaniach (jeśli dotyczy) i przesłać mi UPO po wysyłce.
...
> **KRS: 0000382243**  
> **Cel szczegółowy: 1884 pomoc dla Marysi Wywiał**  
> Instrukcja krok po kroku: https://marysia15.github.io/  
...
- miała założony stały aparat ortodontyczny (który poprawił napięcia w obszarze twarzoczaszki),
- ukończyła szereg turnusów rehabilitacyjnych.
...
### Gdzie mogę śledzić postępy leczenia i rehabilitacji Marysi?
Najświeższe informacje publikujemy na profilu **„Marysia na przekór diagnozom”**:  
...
### Jakie dane mam wpisać, żeby przekazać 1,5% dla Marysi?
Wpisz dokładnie:
- **KRS (OPP): 0000382243**
- **Cel szczegółowy: 1884 pomoc dla Marysi Wywiał**
...
### Gdzie dokładnie w Twój e-PIT znaleźć pole do przekazania 1,5%?
Po zalogowaniu do **e-Urzędu Skarbowego → Twój e-PIT** znajdziesz sekcję **„1,5% podatku dla OPP”**.  
Kliknij **Dodaj/Zmień**, wpisz KRS i cel szczegółowy, zapisz, a następnie zaakceptuj/wyślij zeznanie.
...
### Czy 1,5% działa, jeśli rozliczam się przez program do PIT / księgową?
Tak. Liczy się, aby w wysłanym zeznaniu były poprawne:
- **KRS: 0000382243**
- **Cel szczegółowy: 1884 pomoc dla Marysi Wywiał**
i żeby zeznanie było wysłane w terminie (albo skutecznie skorygowane w terminie).

---

### Dlaczego czasem 1,5% nie trafia, mimo że ktoś wpisał KRS?
Najczęstsze powody to:
- zeznanie złożone po terminie (albo korekta złożona po “okienku” na zmianę 1,5%),
- brak zapłaty podatku należnego w wymaganym czasie (jeśli występuje podatek do zapłaty),
- błędny KRS lub brak celu szczegółowego (przy subkoncie).

---

## Darowizny (przelew, zagranica, online)

### Jak wpisać tytuł przelewu, żeby trafiło na subkonto Marysi?
Wpisz dokładnie:  
**1884 pomoc dla Marysi Wywiał**

---

### Jakie dane do przelewu (PLN)?
- **Konto (PLN): PL31 1090 2835 0000 0001 2173 1374**
- **Tytuł:** 1884 pomoc dla Marysi Wywiał

---

### Czy mogę wpłacić z zagranicy (SWIFT/IBAN) i w jakiej walucie?
Tak:
- **IBAN:** PL31109028350000000121731374  
- **SWIFT:** WBKPPLPP  
- **Title:** 1884 Help for Marysia Wywial  

Najprościej jest wysłać w **PLN**, ale przelew zagraniczny może iść też w innej walucie (bank nadawcy pokaże opcje i koszty).
...
## Fundacja i formalności

### Kim jest Fundacja Kawałek Nieba i co znaczy, że to OPP?
**Fundacja Pomocy Dzieciom i Osobom Chorym „Kawałek Nieba”** jest **OPP (Organizacja Pożytku Publicznego)**, czyli organizacją uprawnioną do otrzymywania 1,5% podatku.  
Jej numer **KRS: 0000382243**.  
Wpisanie **celu szczegółowego** kieruje środki na subkonto Marysi w ramach fundacji.


# Wybór pytań z FAQ na landing page
...
### Kim jest Fundacja Kawałek Nieba?